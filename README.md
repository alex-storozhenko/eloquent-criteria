...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/eloquent-criteria.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/eloquent-criteria)
...
```bash
php artisan vendor:publish --tag="eloquent-criteria-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="eloquent-criteria-views"
```
